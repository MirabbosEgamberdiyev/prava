...
export function Hero_Banner() {
  ...
  return (
    <section className={classes.heroTwoColSection} aria-label={t("home.hero.ariaLabel", "Asosiy qism")}>
      <div className={classes.heroGridContainer}>
        ...
        <div className={classes.heroLeftCol}>
          ...
          {/* 2. Main Headline */}
          <h1 className={classes.heroTwoColTitle}>
          ...
          {/* 3. Subtitle */}
          <p className={classes.heroTwoColSubtitle}>
            {t(
              "home.hero.description",
              "1,190+ rasmiy savollar, 70 ta bilet va IIV YHXBB davlat imtihoni simulyatori. Kompyuter yoki telefon orqali bilimlaringizni sinovdan o'tkazing va imtihondan birinchi urinishda o'ting."
            )}
          </p>
          ...
          {/* 6. Trust Checklist (2x2 grid) */}
          <div className={classes.heroTrustChecklist}>
        ...
        <div className={classes.heroRightCol}>
          <HeroMockup />
        </div>
      </div>
    </section>
