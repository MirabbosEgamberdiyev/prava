...
export const AccessibilityProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // Apply DOM attributes and CSS variables immediately to <html>
  useEffect(() => {
    if (typeof document === "undefined") return;

    const root = document.documentElement;

    // Core V5 attributes: data-text-size and data-bold-text
    ...
    // Persist to both modern and legacy keys
    try {
