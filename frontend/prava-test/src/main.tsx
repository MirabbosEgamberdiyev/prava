...
import { initPendingSubmits } from "./services/pendingSubmits";
...
// P1-W5: saqlanmagan imtihon natijalarini qayta yuborish (online + app start)
initPendingSubmits();

// P1-W6: faqat aktiv til locale chunk'i yuklanadi — xom kalitlar ko'rinmasligi
// uchun birinchi render til yuklangandan keyin.
void i18nReady.then(() => {
