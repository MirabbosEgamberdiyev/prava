...
export const QuestionViewModal = ({
  ...
  const { question: viewQuestion } = useQuestion(opened ? questionId : null);
        ...
        <Stack gap="md">
          <Group gap="xs">
            ...
            {viewQuestion.difficulty && (
              <Badge
                variant="dot"
                color={difficultyColors[viewQuestion.difficulty]}
              >
                {viewQuestion.difficulty}
              </Badge>
            )}
          ...
          <Group gap="xs">
            ...
            <Text size="sm">
              {t("questions.successRate")}: <strong>{viewQuestion.successRate}%</strong>
            </Text>
          </Group>
