...
export const QuestionList = ({ searchQuery, topicId }: QuestionListProps) => {
  ...
  return (
    <Box>
                ...
                <Stack gap="xs">
                  ...
                  <Group mt="md" gap="xl">
                    ...
                    <Group gap={5} c="dimmed">
                      ...
                      <Text size="xs">{t("questions.successRate", { rate: q.successRate })}</Text>
                    </Group>
                  </Group>
                </Stack>
              </Grid.Col>
                  ...
                  <Grid.Col span={{ base: 12, sm: 6 }} key={option.id}>
                    <Paper
                      ...
                      style={{
                        borderColor:
                          q.correctAnswerIndex === option.optionIndex
                            ? isDark ? "var(--mantine-color-green-7)" : "var(--mantine-color-green-4)"
                            : "",
                      }}
                    >
      ...
      {/* Modallar - endi alohida komponentlar */}
      <QuestionViewModal
